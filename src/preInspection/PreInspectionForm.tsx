...
import { createPreInspectionMutation, updatePreInspectionMutation } from './preInspectionQueries'
...
type PreInspectionProps = {
  ...
  loading?: boolean
  onPreInspectionChange: () => Promise<unknown>
} & TabChildProps
...
const PreInspectionForm: React.FC<PreInspectionProps> = observer(
  ({ preInspection, loading: inspectionLoading, onPreInspectionChange }) => {
